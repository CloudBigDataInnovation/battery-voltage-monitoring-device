...
void __attribute__((picinterrupt(("")))) ISR(void)
{
  if(TMR1IF)
  {
    if(Check==0)
    {
      ...
      PORTCbits.RC2 =0;
      PORTCbits.RC3 =0;
      PORTD = Segments_Code[SevenSeg1_Digits[0]];
    }
    if(Check==1)
    {
      PORTD = 0x00;
      ...
      PORTCbits.RC2 =0;
      PORTCbits.RC3 =0;
      PORTD = Segments_Code[SevenSeg1_Digits[1]];
    }
    if(Check==2)
    {
      PORTD = 0x00;
      ...
      PORTCbits.RC2 =1;
      PORTCbits.RC3 =0;
      PORTD = Segments_Code[SevenSeg1_Digits[2]];
    }
    if(Check==3)
    {
      PORTD = 0x00;
      ...
      PORTCbits.RC2 =0;
      PORTCbits.RC3 =1;
      PORTD = Segments_Code[SevenSeg1_Digits[3]];
    }
